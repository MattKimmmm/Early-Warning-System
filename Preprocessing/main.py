...
from preprocess import create_dataset_bin, aggregate_bins
import time

RANDOM_SEED = 42
BATCH_SIZE = 16
NUMS_BIN = [15, 20, 25]
NUMS_BIN_SEPSIS = [2, 5, 10, 15, 20, 25]
NUMS_BIN_SINGLE = [10]
...
aggregate_bins("cardiac arrest", NUMS_BIN_SINGLE, BATCH_SIZE, RANDOM_SEED)
# aggregate_bins("sepsis", NUMS_BIN, BATCH_SIZE, RANDOM_SEED)
